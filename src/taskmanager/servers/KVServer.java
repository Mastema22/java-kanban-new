    ...
    private void load(HttpExchange httpExchange) throws IOException {
        try {
            ...
            if (!hasAuth(httpExchange)) {
                System.out.println("Несанкционированный запрос, параметр API_TOKEN, необходимый в запросе со значением API-ключа");
            ...
            if ("GET".equals(httpExchange.getRequestMethod())) {
                ...
                System.out.println("/загрузка ожидает GET-запроса, но получила: " + httpExchange.getRequestMethod());
